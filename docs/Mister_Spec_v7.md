...
**3. Modo treino (condução em campo — `ModoTreino`).** Acionado pelo botão **"▶ Iniciar treino"** no topo (cor **laranja Mister**, **largura total em mobile**). Abre uma **vista em ecrã cheio** focada num exercício de cada vez:
